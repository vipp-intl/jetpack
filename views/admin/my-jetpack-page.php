					...
					<div class="connection-details local-user j-row">
						...
						<div class="j-col j-lrg-4 j-md-12 j-sm-12 wp-action">
							...
							<div class="action-btns">
								...
								<# } else { #>
									<a class="button button-primary" title="<?php esc_attr_e( 'Link your account to WordPress.com', 'jetpack' ); ?>" href="<?php echo Jetpack::init()->build_connect_url( false, Jetpack::admin_url( array( 'page' => 'my_jetpack' ) ), 'my-jetpack-account' ); ?>" ><?php esc_html_e( 'Link your account', 'jetpack' ); ?></a>
								<# } #>
							</div>
						</div>
					</div>
