		...
		<table class="form-table">
			<tr>
				...
				if ( $this->check_user_connection() ) {
					...
					<p>
						<a href="<?php echo $jetpack->build_connect_url( false, get_edit_profile_url( get_current_user_id() ) . '#post-by-email', 'pbe-account' ); ?>" class="button button-connector" id="wpcom-connect"><?php esc_html_e( 'Link account with WordPress.com', 'jetpack' ); ?></a>
					</p>
					<?php
				} ?>
				</td>
