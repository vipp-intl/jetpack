	...
	function page_admin_scripts() {
		...
		if ( Jetpack::is_active() ) {
			wp_localize_script(
				...
				'glanceData',
				array(
					'protect'           => Jetpack_Admin_Data::glance_site_security_protect_state(),
					'scan'              => Jetpack_Admin_Data::glance_site_security_scan_state(),
					'monitor'           => Jetpack_Admin_Data::glance_site_security_monitor_state(),
					'anti-spam'         => Jetpack_Admin_Data::glance_site_health_akismet_state(),
					'site-backups'      => Jetpack_Admin_Data::glance_site_health_backup_state(),
					'img-performance'   => Jetpack_Admin_Data::glance_traffic_tools_img_performance_state(),
					'plugin-updates'    => Jetpack_Admin_Data::glance_site_health_plugin_updates_state(),
					'site-verification' => Jetpack_Admin_Data::glance_traffic_tools_site_verification_state(),
				)
			);
		}
	}
